...
#define NRF24L01_SPI_CS_ENABLE()    HAL_GPIO_WritePin(GPIOB,GPIO_PIN_1,GPIO_PIN_RESET)
#define NRF24L01_SPI_CS_DISABLE()   HAL_GPIO_WritePin(GPIOB,GPIO_PIN_1,GPIO_PIN_SET)
...
#define NRF24L01_IRQ_PIN_READ()  HAL_GPIO_ReadPin(GPIOA,GPIO_PIN_4)
